...
public class CommentsViewService implements CommentsViewsUseCase {
    ...
    @Override
    public Map<PostId, List<Object>> getCommentsOnOwnPosts(ViewCommentsQuery viewCommentsQuery) {
    ...
    @Override
    public Map<UserId, Map<PostId,List<Object>>> getLatestCommentsOnOwnOrFollowingPosts(ViewCommentsQuery viewCommentsQuery) {
